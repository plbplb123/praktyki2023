...
const gdzieoceny = (list) => list.filter((book) => book.rating > 5);
const gdziestrony = (list) => list.filter((book) => book.pages % 2 != 0);
const gdzietytul = (list) => list.filter((book) => /\d/.test(book.title));
